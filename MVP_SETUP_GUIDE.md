# MoleTracker MVP - Setup-Anleitung für iPhone-Testing

Diese Anleitung führt Sie durch alle Schritte, um ein funktionsfähiges MVP (Minimum Viable Product) der MoleTracker-App auf Ihrem iPhone zu testen.
...
- **Product Name**: `MoleTracker`
- **Team**: Wählen Sie Ihren Apple ID Account
- **Organization Identifier**: `com.yourname` (z.B. `com.wolfram`)
- **Bundle Identifier**: Wird automatisch generiert (z.B. `com.wolfram.MoleTracker`)
- **Interface**: **SwiftUI**
- **Storage**: **SwiftData**
- **Language**: **Swift**

5. Klicken Sie auf **"Next"**
6. Wählen Sie einen Speicherort (z.B. Desktop/MoleTracker)
...
1. Rechtsklick auf **MoleTracker** (gelber Ordner) → **New Group**
...
Öffnen Sie `MoleTrackerApp.swift` und ersetzen Sie den Inhalt:
...
<string>MoleTracker benötigt Zugriff auf die Kamera, um Fotos von Leberflecken aufzunehmen.</string>
<key>NSPhotoLibraryUsageDescription</key>
<string>MoleTracker benötigt Zugriff auf die Fotobibliothek, um Bilder zu speichern.</string>
```
...
- Bundle Identifier ändern (z.B. `com.yourname.MoleTracker2`)
