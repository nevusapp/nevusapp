...
**Location:** `MoleTracker/Services/GuidedScanningService.swift`
...
**Location:** `MoleTracker/Views/GuidedScanningView.swift`
...
**Location:** `MoleTracker/Views/ContentView.swift`
...
### Created:
1. `MoleTracker/Services/GuidedScanningService.swift` (95 lines)
2. `MoleTracker/Views/GuidedScanningView.swift` (475 lines)
3. `MoleTracker/GUIDED_SCANNING_FEATURE.md` (this file)

### Modified:
1. `MoleTracker/Views/ContentView.swift`
   - Added state variable for guided scanning
   - Added menu item
   - Added sheet presentation

2. `MoleTracker/MoleTracker/Localizable.xcstrings`
   - Added 25+ localization strings for guided scanning

3. `MoleTracker/MoleTracker.xcodeproj/project.pbxproj`
