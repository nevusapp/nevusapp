...
4. **Verify System Settings**:
   - Open iOS Settings > Notifications > MoleTracker
...
### New Files
- `MoleTracker/Services/NotificationService.swift`
- `MoleTracker/MONTHLY_REMINDER_FEATURE.md` (this file)

### Modified Files
- `MoleTracker/Services/GuidedScanningService.swift`
- `MoleTracker/MoleTracker/MoleTrackerApp.swift`
- `MoleTracker/MoleTracker/Localizable.xcstrings`
- `MoleTracker/MoleTracker.xcodeproj/project.pbxproj`
