...
### Configuration
5. **`MoleTracker/Info.plist`**
   - Document type registration for .moletracker files
   - UTI declarations (com.moletracker.sync-package)
...
1. **`Services/ExportService.swift`**
   ...
   - Creates .moletracker ZIP packages
...
- ✅ Automatic file handling (.moletracker)
...
1. Save .moletracker file to Files
2. Open MoleTracker
...
**File Extension:** `.moletracker`

**Structure:**
```
MoleSync_since_YYYY-MM-DD.moletracker (ZIP file)
