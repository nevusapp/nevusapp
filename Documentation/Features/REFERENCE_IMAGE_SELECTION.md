...
## Dateien
- `Nevus/Models/Mole.swift` - Datenmodell mit Referenzbild-Logik
- `Nevus/Views/MoleDetailView.swift` - UI für Auswahl und Anzeige
- `Nevus/Views/CameraView.swift` - Overlay-Integration