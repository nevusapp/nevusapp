...
6. Ensure "Nevus" target is **checked**
7. Click "Add"
...
Add support for `.nevus` files so iOS knows to open them with your app.

1. In Xcode, select the **Nevus** project in the navigator
2. Select the **Nevus** target
3. Go to the **Info** tab
4. Expand **Document Types** section
5. Click the **+** button to add a new document type
6. Configure as follows:
   - **Name**: Nevus Sync Package
   - **Types**: `com.nevus.sync-package`
   - **Extensions**: `nevus`
   - **Role**: Editor
   - **Rank**: Owner
...
9. Configure as follows:
   - **Description**: Nevus Sync Package
   - **Identifier**: `com.nevus.sync-package`
   - **Conforms To**: `public.data`
   - **Extensions**: `nevus`

## Step 3: Add Localization Strings

Add the following strings to `Nevus/Localizable.xcstrings`:
...
- Make sure you registered the .nevus file type in Info.plist
