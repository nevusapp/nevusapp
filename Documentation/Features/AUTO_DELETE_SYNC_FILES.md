...
This feature automatically deletes `.nevus` sync files from the Files app after successful import, eliminating the need for manual cleanup.
...
3. **`Views/ImportConfirmationView.swift`**
   ...
   - Environment object passed from NevusApp
...
✅ Deleted original sync file from Files app: MoleSync_since_2026-03-15.nevus
```
...
⚠️ Failed to delete original file: [error details]
   User can manually delete: MoleSync_since_2026-03-15.nevus
```
